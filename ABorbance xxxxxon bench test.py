...
folder_path = 'D:\\Experimental Files\\20240212\\oceanview\\actual uvvis\\0.9 5min/*.txt'  # Update with your folder path
...
result_df.to_csv('0.1V_CA_20240212.csv', index=False)

data = pd.read_csv('0.1V_CA_20240212.csv')
...
plt.scatter(x, y1, label='Range 275 to 310 nm', color='red', marker='o')
plt.scatter(x, y2, label='Range 530 to 650 nm', color='blue', marker='x')
plt.scatter(x, y3, label='Range 650 to 700 nm', color='green', marker='^')

# Set plot title and labels
plt.title('0.1V Absorbance Peaks Average of 3 Scans')
